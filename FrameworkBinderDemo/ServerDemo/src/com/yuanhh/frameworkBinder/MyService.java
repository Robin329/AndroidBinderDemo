...
public
    MyService() { this.attachInterface(this, DESCRIPTOR); }
...
public
    static com.robin.frameworkBinder.IMyService asInterface(android.os.IBinder obj) {
        if ((obj == null)) {
            return null;
        }
        android.os.IInterface iInterface = obj.queryLocalInterface(DESCRIPTOR);
        if (((iInterface != null) && (iInterface instanceof com.robin.frameworkBinder.IMyService))) {
            return ((com.robin.frameworkBinder.IMyService)iInterface);
        }
        return null;
    }
